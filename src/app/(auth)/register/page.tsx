...
//
// On success: calls POST /api/auth/register → redirects to /login
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Join EventSync — free to get started
        </p>
      </div>
            ...
            {([
              {
                ...
                icon:  User,
                title: "Plan Events",
                desc:  "Browse vendors, build your event, track budgets",
              },
              {
                role:  "VENDOR" as Role,
                icon:  Building2,
                title: "Grow My Business",
                desc:  "Manage bookings, inventory, staff & finances",
              },
