  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Sign in to your EventSync account</p>
      </div>
      ...
      <div className="rounded-lg border border-dashed border-border p-4 space-y-2">
        ...
        {DEMO_ACCOUNTS.map((d) => (
          <button key={d.role} type="button"
            ...
            <span className="text-muted-foreground font-mono group-hover:text-foreground">{d.email}</span>
          </button>
        ))}
      </div>
